...
public:
  MiniCatalogue(std::string schemaName,
                ...
                std::shared_ptr<std::unordered_map<std::shared_ptr<cache::SegmentKey>, std::vector<size_t>, cache::SegmentKeyPointerHash, cache::SegmentKeyPointerPredicate>> segmentKeyToTableColumnPartitionIndex,
  ...
  new start
  */
  std::vector<size_t> getSegmentSizegetSegmentTablePartitionColumnIndex(const std::shared_ptr<cache::SegmentKey>& segmentKey);
  /*
  new end
  */
...
private:
  ...
  /*
  table name->index    column name->index
  */
  std::shared_ptr<std::unordered_map<std::string, int>> tableIndex_;
  std::shared_ptr<std::vector<std::unordered_map<std::string, int>>> columnsIndex_;
  std::shared_ptr<std::unordered_map<std::shared_ptr<cache::SegmentKey>, std::vector<size_t>, 
    cache::SegmentKeyPointerHash, cache::SegmentKeyPointerPredicate>> segmentKeyToTableColumnPartitionIndex_;
