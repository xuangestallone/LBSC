 ...
 */
// c5a.8x
// inline constexpr double vNetwork = 1.16320;     // unit: GB/s    1.831  MB/s
// inline constexpr double vS3Scan = 18.00891;     // unit: GB/s     25.6456 MB/s
// inline constexpr double vS3Filter = 0.32719;    // unit: GPred/s

inline constexpr double vNetwork = 1.831;  
inline constexpr double vS3Scan = 25.6456;    
inline constexpr double vS3Filter = 0.32719;
