...
#ifndef NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_TRAITS_H
#define NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_TRAITS_H
...
#endif //NORMAL_NORMAL_UTIL_INCLUDE_NORMAL_UTIL_TRAITS_H
