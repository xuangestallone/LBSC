...
enum SkewBitMapAndDPQueryName {
  SkewBitMapAndDPQuery0,
  SkewBitMapAndDPQuery2,
  SkewBitMapAndDPQuery3,
  SkewBitMapAndDPQuery4,
  SkewBitMapAndDPQuery5,
  SkewBitMapAndDPUnknown
};
...
public:
  ...
  std::vector<std::string> generateSqlBatchSkewWeightForDP(float skewness, int batchSize);
  std::string generateSqlSkewWeightForDP(std::string queryName, std::string skewLo_predicate, bool high, int& testForQuery0Num);

  std::vector<std::string> generateSqlBatchSkewWeightForBitMap(float skewness, int batchSize);
  std::string generateSqlSkewWeightForBitMap(std::string queryName, std::string skewLo_predicate, bool high, int& testForBitMap);

  std::vector<std::string> generateSqlBatchSkewWeightForBitMapAndDP(float skewness, int batchSize);
  std::string generateSqlSkewWeightForBitMapAndDP(std::string queryName, std::string skewLo_predicate, bool high);
...
private:
  ...
  std::map<std::string, SkewDPQueryName> skewDPQueryNameMap_;
  std::map<std::string, SkewBitMapQueryName> skewBitMapQueryNameMap_;
  std::map<std::string, SkewBitMapAndDPQueryName> skewBitMapAndDPQueryNameMap_;
  ...
  std::string genSkewWeightQuery0(int low_orderkey);
  std::string genSkewWeightQuery5(std::string skewLo_predicate);
