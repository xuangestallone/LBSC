...
void Planner::setBitmap(bool isBitmap){
  isBitmap_ = isBitmap;
}


bool Planner::getBitmap(){
  return isBitmap_;
}

void Planner::setSplit(bool isSplit){
  isSplit_ = isSplit;
}

bool Planner::getSplit(){
  return isSplit_;
}

void Planner::setVKeyDate(std::vector<std::set<int>> vKeyDate){
  vKeyDate_ = std::move(vKeyDate);
}

void Planner::setSLoCommitdate(std::map<std::string,int> sLoCommitdate){
  sLoCommitdate_ = std::move(sLoCommitdate);
}

void Planner::setSLoCommitdateInt(std::map<int,int> sLoCommitdateInt){
  sLoCommitdateInt_ = std::move(sLoCommitdateInt);
}

 void Planner::setVBitmap(std::vector<std::vector<unsigned long long>> vBitMap){
  vBitMap_ = std::move(vBitMap);
 }

// void Planner::setLoQuantity(long loQuantity){
//   loQuantity_ = loQuantity;
// }

// long Planner::getLoQuantity(){
//   return loQuantity_;
// }