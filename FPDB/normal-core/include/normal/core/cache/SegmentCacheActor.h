...
//new
// using GetNumPartialHitsAtom = atom_constant<atom("NumParHit")>;
// using GetNumPartialMissesAtom = atom_constant<atom("NumParMis")>;
...
//new
// using GetCrtQueryNumPartialHitsAtom = atom_constant<atom("CNmParHit")>;
// using GetCrtQueryNumPartialMissesAtom = atom_constant<atom("CNmParMis")>;
...
//new 
// using ClearCrtQueryPartialMetricsAtom = atom_constant<atom("ClrCParMet")>;

using MetricsAtom = atom_constant<atom("Metrics")>;

//new
// using MetricsPartialAtom = atom_constant<atom("MetricsPar")>;
