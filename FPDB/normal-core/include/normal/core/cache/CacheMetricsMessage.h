...
public:
  // CacheMetricsMessage(size_t hitNum, size_t missNum, size_t shardHitNum, size_t shardMissNum, 
  //           double partialHitNum, double partialMissNum, const std::string &sender);
  // static std::shared_ptr<CacheMetricsMessage> make(size_t hitNum, size_t missNum, size_t shardHitNum, size_t shardMissNum, 
  //           double partialHitNum, double partialMissNum, const std::string &sender);
  ...
  // double getPartialHitNum() const;
  // double getPartialMissNum() const;
...
private:
  ...
  //new
  // double partialHitNum_;
  // double partialMissNum_;
};
