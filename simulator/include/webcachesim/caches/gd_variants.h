...
class GDSFCostCache : public GreedyDualBase
{
protected:
    CacheStatsMapType _reqsMap;
...
static Factory<GDSFCostCache> factoryGDSFCost("GDSFCost");


class CostSizeCache : public GreedyDualBase
{
protected:
...
static Factory<CostSizeCache> factoryCostSize("CostSize");
